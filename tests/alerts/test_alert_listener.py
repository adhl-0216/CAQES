...
from alerts.worker import JOBS_STREAM, Worker, ALERTS_STREAM
...
@pytest.mark.asyncio
async def test_close(listener: Worker):
    """
...
@pytest.mark.asyncio
async def test_close_error(listener: Worker):
    """
...
@pytest.mark.asyncio
async def test_start(listener: Worker):
    """
    Test successful start of the alert listener
    """
    # Setup mocks
    listener.connect = AsyncMock()
    listener._ensure_stream = AsyncMock()
    ...
    listener._ensure_stream.assert_called_once()
...
@pytest.mark.asyncio
async def test_start_connection_error(listener: Worker):
    """
...
@pytest.mark.asyncio
async def test_ensure_streams_create_new(listener: Worker):
...
@pytest.mark.asyncio
async def test_ensure_streams_mixed_state(listener: Worker):
...
@pytest.mark.asyncio
async def test_ensure_streams_creation_error(listener: Worker):
...
@pytest.mark.asyncio
async def test_handle_alert_message_success(listener: Worker):
    """
...
@pytest.mark.asyncio
async def test_handle_alert_message_publish_error(listener: Worker):
    """
...
@pytest.mark.asyncio
async def test_handle_alert_message_empty_data(listener: Worker):
    """
